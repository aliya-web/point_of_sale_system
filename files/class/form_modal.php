        ...
        <div class="modal-dialog"><!-- modal-dialog-centered -->
            <div class="modal-content">
                <div class="modal-header display-6 bg-primary ">
                    <h3 class="text-center text-light"><b>ຟອມບັນທືກໂຊນສິນຄ້າ</b></h3>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="class_name" id="class_name" class="form-control class_name" placeholder="ປ້ອນໂຊນສິນຄ້າ....." >
                                    </div>
                                </div>
                                <div class="form-group mt-3">
                                    ...
                                    <center>
                                        <button type="button" class="btn bg-success text-light" id="go">
