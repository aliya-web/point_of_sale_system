...
<body>
    <?php
        include("../../Connect.php");
        $select=mysqli_query($con,"SELECT * FROM categories as a, products as b where b.cate_id=a.cate_id and prod_qty=0 ");
            ...
            <div class="col-sm-12">
                <div class="card shadow-lg mt-3">
                    <div class="tag-header">
                        <h2 class="mt-3 text-center title"><b><u>ລາຍງານຂໍ້ມູນສິນຄ້າທີ່ໝົດແລ້ວ</u></b></h2>
                        <hr>
                    </div>
                    <div class="tag-body">
                        <!-- .... -->
