...
<body>
    <?php
        include("../../Connect.php");
        $select=mysqli_query($con,"SELECT * FROM categories as a, products as b,class as c where b.cate_id=a.cate_id and b.class_id=c.class_id and prod_qty=0 ");
        $count_pro=mysqli_query($con,"SELECT count(prod_id) from products where prod_qty=0 ");
            ...
            <div class="col-sm-12">
                <div class="card shadow-lg mt-3">
                    <div class="tag-header">
                        <h4 class="mt-3 text-center title"><b><u>ລາຍງານຂໍ້ມູນສິນຄ້າທີ່ໝົດແລ້ວ</u></b></h4>
                        <hr>
                    </div>
                    <div class="tag-body">
                        <!-- .... -->
                        
                    <p class="count"><u><b>ຈຳນວນລາຍການສິນຄ້າທີ່ໝົດແລ້ວມີ: <?php echo $count[0];?> ລາຍການ</b></u></p>
                        <div class="show">
