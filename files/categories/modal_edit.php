        ...
        <div class="modal-dialog"><!-- modal-dialog-centered -->
            <div class="modal-content">
                <div class="modal-header display-6 bg-primary">
                    <h3 class="text-center text-light"><b>ຟອມແກ້ໄຂຂໍ້ມູນປະເພດສິນຄ້າ</b></h3>
                    ...
                    <!-- <div class="card-body"> -->
                        <form action="update.php" method="POST" class="">
                            <div class="row">
                                <div class="col-sm-12">
                                    <!-- ............ -->
                                    <input type="hidden" name="cate_id1" class="form-control cate_id1" id="cate_id1">
                                    <!-- ............ -->
                                    <div class="form-group">
                                        <label for="">ປະເພດສິນຄ້າ</label>
                                        <input type="text" name="cate_name1" id="cate_name1" class="form-control cate_name1" 
